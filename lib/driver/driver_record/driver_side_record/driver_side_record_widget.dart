...
/// login as a driver
class DriverSideRecordWidget extends StatefulWidget {
  const DriverSideRecordWidget({
    super.key,
    this.city,
  });
  ...
  static String routeName = 'DriverSideRecord';
  static String routePath = '/driverSideRecord';

  @override
  State<DriverSideRecordWidget> createState() => _DriverSideRecordWidgetState();
}

class _DriverSideRecordWidgetState extends State<DriverSideRecordWidget> {
  late DriverSideRecordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriverSideRecordModel());
            ...
            children: [
              ...
              Align(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await actions.startGpsRecording(
                      false,
                      false,
                      '',

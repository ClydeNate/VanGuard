...
import 'app_announce_prio_model.dart';
export 'app_announce_prio_model.dart';

/// Resize the components and make it even
class AppAnnouncePrioWidget extends StatefulWidget {
  const AppAnnouncePrioWidget({super.key});

  static String routeName = 'AppAnnouncePrio';
  static String routePath = '/appAnnouncePrio';

  @override
  State<AppAnnouncePrioWidget> createState() => _AppAnnouncePrioWidgetState();
}

class _AppAnnouncePrioWidgetState extends State<AppAnnouncePrioWidget> {
  late AppAnnouncePrioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppAnnouncePrioModel());
  }
